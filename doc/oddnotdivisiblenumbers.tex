...
To solve (\ref{eq:intersection1}) respectively (\ref{eq:intersection2}), we recognize that we have the boundary condition, that $\left(2x_{i}^{\left(1\right)} + 1\right)$ and $\left(2x_{i}^{\left(2\right)} + 1\right)$ must not have any common factors.
